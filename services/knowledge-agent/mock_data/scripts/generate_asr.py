    ...
    def cross_border_02() -> tuple:
        ...
        return (
            [
                ...
                {"role": "agent", "text": "没关系！我们也建议您下载手机银行APP开通交易实时提醒功能，这样每一笔消费都能在手机上即时看到明细。"},
            ],
            "确认交易为本人操作",
            "anxious_to_relieved"
        )
    ...
    def benefits_01() -> tuple:
        ...
        return (
            [
                ...
                {"role": "agent", "text": "您好，积分兑换的方式很多。您可以登录手机银行APP进入积分商城，可以兑换实物礼品、优惠券、视频会员、航空里程等。8万积分大概可以兑换价值约400元的商品。"},
    ...
    def benefits_02() -> tuple:
        ...
        return (
            [
                ...
                {"role": "agent", "text": "使用机场贵宾厅非常方便。您只需要在手机银行APP上提前预约，或者直接到机场贵宾厅前台出示您的白金卡和登机牌即可。目前覆盖深圳、北京、上海、广州等主要机场，部分机场还支持带一位同行人。"},
    ...
    def new_user_01() -> tuple:
        ...
        return (
            [
                ...
                {"role": "agent", "text": "很简单，您先下载手机银行APP用手机号登录，然后在APP里激活卡片。之后日常消费自动就会触发这些奖励。另外建议您开通自动还款功能，这样不会忘记还款，还额外送20元话费券。"},
    ...
    def general_01() -> tuple:
        ...
        return (
            [
                ...
                {"role": "agent", "text": "您好，更新手机号可以在手机银行APP上操作，路径是：我的→设置→安全中心→修改手机号。需要验证身份证号和原手机号接收验证码。如果您原手机号已经不能用了，需要携带身份证到任意XX银行网点办理。"},
