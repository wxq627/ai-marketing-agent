...
BENEFIT_DEFINITIONS = [
    ...
    ("BEN_PTS_008", "积分抵现", "积分", "掌上生活APP内商城/饭票等场景可用积分直接抵扣现金，比例约500:1"),
    ...
    # ---- 消费权益 (12项) ----
    ("BEN_SPD_001", "Apple Pay笔笔1%返现", "消费", "通过Apple Pay使用招行信用卡消费享1%返现，境内单笔最高10元/月上限100元，境外单笔最高50元/月上限200元"),
    ("BEN_SPD_002", "境外消费返现", "消费", "境外线下消费返现5%，月上限500元人民币，需在掌上生活APP报名参与"),
    ...
    ("BEN_SPD_009", "家电以旧换新补贴", "消费", "苏宁/京东家电以旧换新额外补贴，刷招行信用卡再享分期免息"),
    ...
    ("BEN_NEW_003", "首刷礼", "新户", "首笔消费满99元赠招行定制礼品（经典保温杯/定制帆布袋/手机支架三选一）"),
    ...
    ("BEN_NEW_007", "新户见面礼", "新户", "首月登录掌上生活APP领腾讯视频VIP月卡或星巴克中杯券"),
...
def build_campaigns() -> List[Dict[str, Any]]:
    ...
    campaigns = [
        ...
        {"campaign_id": "CAMP_2026_APPLEPAY", "name": "Apple Pay笔笔1%返现",
         ...
         "rules": {"境内返现":0.01,"境内单笔上限":10,"境内月上限":100,"境外返现":0.01,"境外单笔上限":50,"境外月上限":200,"报名渠道":"掌上生活APP"},
